  ...
  return (
    <div className="bg-background text-text font-sans">
      ...
      <Section
        ...
        subtitle="I transform complex requirements into seamless, high-performance digital products that users love."
      >
        <div className="flex flex-col lg:flex-row gap-20 items-center">
              ...
              <div className="relative bg-card rounded-[40px] p-8 md:p-12 border border-white/5 shadow-2xl overflow-hidden">
                ...
                <div className="grid grid-cols-2 gap-4 sm:gap-6">
                  <div className="p-8 bg-background border border-white/5 rounded-3xl text-center group-hover:border-accent/20 transition">
                    <h4 className="text-4xl font-black text-accent mb-2 tracking-tighter">02+</h4>
                    <span className="text-gray-500 text-[10px] font-black uppercase tracking-[0.2em]">Years XP</span>
                  </div>
                  <div className="p-8 bg-background border border-white/5 rounded-3xl text-center group-hover:border-accent/20 transition">
                    <h4 className="text-4xl font-black text-accent mb-2 tracking-tighter">25+</h4>
                    <span className="text-gray-500 text-[10px] font-black uppercase tracking-[0.2em]">Crafted</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex-1 text-center lg:text-left">
            <h3 className="text-3xl font-black text-text mb-8 leading-tight">MERN STACK ARCHITECT & SHOPIFY SPECIALIST</h3>
            <p className="text-gray-400 text-xl mb-12 leading-relaxed">
              Based in Pakistan, I specialize in building complete digital ecosystems.
              Whether it's a high-scale Shopify Plus store or a bespoke cloud-native MERN application,
              I focus on code integrity and visual perfection.
            </p>
      ...
      <Section
        ...
        subtitle="Comprehensive development services from conception to deployment."
