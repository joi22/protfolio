...
export default function TestimonialCard({ testimonial, index }: TestimonialCardProps) {
    return (
        <motion.div className="p-5 rounded-xl mx-4 w-72 shrink-0 bg-slate-900/40 border border-slate-800/80 glow-border"
        ...
        >
            ...
            <p className="text-sm pt-4 text-slate-300 leading-relaxed italic">
                "{testimonial.quote}"
            </p>
        </motion.div>
    );
